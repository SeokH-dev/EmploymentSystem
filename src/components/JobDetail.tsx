...
const mockJobDetail: Job = {
  ...
  details: {
    ...
    requiredSkills: ['React', 'TypeScript', 'Next.js', 'Tailwind CSS', 'JavaScript', 'HTML/CSS', '정보처리기사', '웹디자인기능사']
  },
          ...
          <div className="bg-white rounded-2xl p-6 mb-6 border border-gray-200">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-base leading-relaxed mb-3">사용자 경험을 중시하는 혁신적인 핀테크 서비스 개발</p>
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-gray-500">추천도</div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200">
                <div className="mb-6">
                  <h3 className="text-xl font-semibold text-gray-900">역량 매치 분석</h3>
                  <p className="text-sm text-gray-500">내 역량과 공고 요구사항 비교</p>
                </div>
                ...
                <div className="flex items-center justify-center space-x-8">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-700">내 역량</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <div className="w-4 h-4 border-2 border-gray-400 border-dashed rounded-full"></div>
                    <span className="text-sm text-gray-700">공고 요구사항</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">기술 스택 매치</h3>
                  <p className="text-sm text-gray-600">보유 기술과 요구 기술 비교</p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {job.details.requiredSkills?.filter(skill => personaSkills.includes(skill)).map((skill) => (
                        <Badge
                          key={skill}
                          className="bg-neutral-100 text-neutral-800 border border-neutral-200 px-3 py-1.5"
                        >
                          {skill}
                        </Badge>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {job.details.requiredSkills?.filter(skill => !personaSkills.includes(skill)).map((skill) => (
                        <Badge
                          key={skill}
                          className="bg-neutral-100 text-neutral-700 border border-neutral-200 px-3 py-1.5"
                        >
                          {skill}
                        </Badge>
                      ))}
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                <div className="mb-4">
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">공고 상세 정보</h3>
                  <p className="text-sm text-gray-600">업무 내용과 지원 자격</p>
                </div>
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-200">
                <div className="flex items-center justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">AI 맞춤 자기소개서</h3>
                  ...
                  <Button
                    ...
                    className="px-2"
                  >
                    <span className="text-sm">{isCoverLetterExpanded ? '접기' : '미리보기'}</span>
                  </Button>
                </div>
                ...
                {isCoverLetterExpanded && (
                  <div className="space-y-6">
                    <div className="p-6 bg-neutral-50 rounded-2xl border border-neutral-200">
                      <h4 className="font-semibold mb-4 text-neutral-900">{job.company} {job.title} 지원서</h4>
                      <div className="text-sm text-gray-700 leading-relaxed whitespace-pre-line">
                        {generateCoverLetterPreview()}
                      </div>
                    </div>
                    <Button
                      className="w-full bg-black hover:bg-neutral-800 text-white py-3 rounded-xl font-medium"
                ...
                {!isCoverLetterExpanded && (
                  <div className="text-center py-6">
                    ...
                    <Button
                      onClick={() => onNavigate('cover-letter')}
                      className="bg-black hover:bg-gray-800 text-white px-6 py-2 rounded-xl font-medium"
                    >
                      자기소개서 작성하기
                    </Button>
                  </div>
            ...
            {/* Right Sidebar - 1/4 (Sticky) */}
              ...
              <div className="sticky top-24 space-y-4">
                {/* AI 추천 이유 */}
                  ...
                  <div className="mb-4">
                        <h3 className="text-base font-semibold text-gray-900 mb-1">AI 추천 이유</h3>
                    ...
                    <div className="space-y-1">
                      {strengths.slice(0, 3).map((item) => (
                        <div key={item.subject} className="flex items-center justify-between text-xs">
                            ...
                            <span className="font-semibold text-gray-700">{item.persona}점</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  {/* 개선점 */}
                    ...
                    <div className="space-y-1">
                      {weaknesses.slice(0, 2).map((item) => (
                        <div key={item.subject} className="flex items-center justify-between text-xs">
                            <span className="text-gray-700">{item.subject}</span>
                            <span className="font-semibold text-gray-700">{item.persona}→{item.job}</span>
                        </div>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-xs">
                      <div className="flex items-start space-x-2">
                        ...
                        <span className="text-gray-700">Next.js 공식 문서 학습</span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-1 h-1 bg-gray-500 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span className="text-gray-700">핀테크 UI/UX 트렌드 연구</span>
                      </div>
                      <div className="flex items-start space-x-2">
                        <div className="w-1 h-1 bg-gray-500 rounded-full mt-1.5 flex-shrink-0"></div>
                        <span className="text-gray-700">성능 최적화 기법 습득</span>
                      </div>
                    </div>
                  </div>
                </div>
